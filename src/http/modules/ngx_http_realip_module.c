...
ngx_http_realip_init(ngx_conf_t *cf)
{
	...
	/*
		phases数组中有11个成员(对应HTTP处理的11个阶段) 取出NGX_HTTP_POST_READ_PHASE阶段的handlers动态数组 向其中添加ngx_http_handler_pt处理方法 
    ...
    *h = ngx_http_realip_handler;
	...
	/*
		...
		例如 phases[NGX_HTTP_PREACCESS_PHASE.handlers]动态数组中也添加了ngx_http_realip_handler方法
	*/
